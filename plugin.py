...
class HexInputScreen(Screen):
    def __init__(self, session, channel_name="", existing_key=""):
        ...
        <screen position="center,center" size="{self.ui.px(1150)},{self.ui.px(650)}" title="BissPro - Key Input" backgroundColor="#1a1a1a">
            ...
            <eLabel text="OK: confirm  |  ◀️ ▶️ : move position  |  ▲ ▼ : letters" position="{self.ui.px(10)},{self.ui.px(280)}" size="{self.ui.px(1130)},{self.ui.px(40)}" font="Regular;{self.ui.font(28)}" halign="center" foregroundColor="#bbbbbb" transparent="1" />
